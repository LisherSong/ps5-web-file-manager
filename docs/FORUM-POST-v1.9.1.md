# PS5 网页文件管理器 v1.9.1（自编译版）发布 + 与上个版本对比 + 使用简介
...
| 维度 | 上游 owendswang v1.8 | 我的 v1.9.1 |
|---|---|---|
...
```sh
# 把 PS5_IP 换成你主机实际 IP
nc -q0 <PS5的IP> 9021 < web-file-mgr-v1.9.1.elf
```
...
- **上传下载**：单文件或文件夹树上传；文件夹/多选以 `.tar` 流式下载。
...
> 请在 GitHub Release 页面下载：`https://github.com/lishersong/ps5-web-file-manager/releases/tag/v1.9.1`

发布文件：`web-file-mgr-v1.9.1.elf`
...
# 应等于 24392aff6ddcca4dc0ea969cce356bd693ac52efe8a117d61ee1c814aa43cd07
```
